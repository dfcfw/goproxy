...
func (dc DirCacher) Get(_ context.Context, name string) (io.ReadCloser, error) {
...
func (dc DirCacher) Put(_ context.Context, name string, content io.ReadSeeker) error {
